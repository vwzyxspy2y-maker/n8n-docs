...
| `N8N_GIT_NODE_DISABLE_BARE_REPOS` | Boolean | `true` | Set to `true` to prevent the [Git node](/integrations/builtin/core-nodes/n8n-nodes-base.git.md) from working with bare repositories, enhancing security. |
